 ...
 * created by zhk
 */
public class CoinFlexTradeJobUpdate2 {
                   ...
                   .map(line -> {
                       ...
                       if(line.indexOf("INSERT INTO cf_trade_history")!=-1){
                           ...
                           if (marketcode.contains("SWAP")) {
                               ...
                               //oldTradeType=SPOT,newTradeType=FUTURE,marketcode=FLEX-BCH
                               //oldTradeType=SPOT,newTradeType=FUTURE,marketcode=flexUSD-USDT
                           ...
                           if(!oldTradeType.equals(newTradeType)&&"TRADE".equals(oldTradeType)){
                               ...
                               //newLine += oldTradeType+","+newTradeType+","+marketcode;
                               return newLine;
                           }else {
                               return "";
                           }
