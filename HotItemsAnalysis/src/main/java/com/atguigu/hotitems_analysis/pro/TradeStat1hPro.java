 ...
 * created by zhk
 */
public class TradeStat1hPro {

    public static boolean tradeStat1hPro = true;
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 2. 读取数据，创建DataStream
        DataStream<String> inputStream = env.readTextFile("/Users/zenghuikang/Downloads/coinflex_cf_trade_history_2021-12-06_sorter.csv");
        ...
        tradeStatRspStream.writeAsText("/Users/zenghuikang/Downloads/trade_stat_1h_pro.sql");
