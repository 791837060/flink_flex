 ...
 */
@Slf4j
public class TradeStatWindowFunction7 implements WindowFunction<TradeStatRsp, TradeStatRsp,
        Tuple7<String, String, String, String, String, String, String>, TimeWindow> {

    @Override
    public void apply(Tuple7<String, String, String, String, String,String, String> tuple5,
        ...
        try {
            ...
            //System.out.println("select sum(quantity*abs(price)) from cf_trade_history cth where source= "+tradeStatRsp.getSource()+" and  account_id = "+tradeStatRsp.getAccountId()+" and   ordertimestamp > "+window.getStart()+" and ordertimestamp <="+window.getEnd()+" and marketcode ='"+tradeStatRsp.getMarketCode()+"' and orderSide='"+tradeStatRsp.getOrderSide()+"' and orderType='"+tradeStatRsp.getOrderType()+"' and timeInforce='"+tradeStatRsp.getTimeInforce()+"' and matchedType='"+tradeStatRsp.getMatchedType()+"';");
