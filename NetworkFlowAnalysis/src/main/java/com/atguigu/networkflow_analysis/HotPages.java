...
public class HotPages {
    public static void main(String[] args) throws Exception {
        ...
        // 读取文件，转换成POJO
        URL resource = HotPages.class.getResource("/Users/zenghuikang/workspace/coinflex/尚硅谷大数据技术之Flink（Java版）/4.代码/UserBehaviorAnalysis/NetworkFlowAnalysis/src/main/resources/apache.log");
        ...
        DataStream<ApacheLogEvent> dataStream = inputStream
                ...
                //Time.seconds(1) 延迟时间为 1s
                .assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<ApacheLogEvent>(Time.seconds(1)) {//有界无序时间戳提取器 乱序数据
                    @Override
...
//            pageViewCountListState = getRuntimeContext().getListState(new ListStateDescriptor<PageViewCount>("page-count-list", PageViewCount.class));
            pageViewCountMapState = getRuntimeContext().getMapState(new MapStateDescriptor<String, Long>("page-count-map", String.class, Long.class)); //状态描述符
        }
